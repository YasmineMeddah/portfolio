  ...
  <div class="container">
    <div class="flex -mx-4 items-center justify-between relative">
      <div class="pr-4 w-60 max-w-full">
        ...
        <span class="text-xl xl:text-2xl font-bold text-[#0c7187] dark:text-white">Yasmine </span> &nbsp
        <span class="text-xl xl:text-2xl font-bold text-[#0c7187] dark:text-white ">Meddah </span>
        </a>
      </div>
