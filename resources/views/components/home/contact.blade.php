...
Adresse mail              </h4>
              <p class="text-base text-body-color dark:text-gray-300">yasminemeddah97@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
     ...
     this.successMessage = 'Merci pour votre demande de contact. Je reviens vers vous dans peu de temps.';
          ...
          x-on:submit.prevent="submitForm">
            ...
            <div class="mb-6">
              <x-forms.input type="email" placeholder="Votre mail" name="email" x-model="formData.email" ::class="errors.email ? 'border-red-500 focus:border-red-500' : ''"></x-forms.input>
              <template x-if="errors.email">
                <div x-text="errors.email[0]" class="text-red-500"></div>
              </template>
            </div>
            <div class="mb-6">
              <x-forms.textarea placeholder="Votre message" name="bady" rows="6" x-model="formData.bady" ::class="errors.message ? 'border-red-500 focus:border-red-500' : ''"></x-forms.textarea>
