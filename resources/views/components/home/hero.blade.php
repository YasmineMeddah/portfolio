    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          >
            Je m'appelle Yasmine <br/>
            Je suis  <span class="rounded-md text-amber-600">Informaticienne</span>.
          </h1>
          <p class="text-base mb-8 max-w-[520px]">
           Je suis dévelopeuse junior avec 2 ans d'expérience <br/>
      ...
      <div class="w-full lg:w-6/12 px-4">
        <div class="lg:text-right lg:ml-auto">
          <div class="relative inline-block z-10 pt-11 lg:pt-0">
            <img
            src="{{ url('/img/image_hero.jpeg') }}"
              alt="hero"
              class="max-w-full lg:ml-auto"> </img>
...
<div style="  height:1px; width:100%; border-top:0.5px solid #0f172a"></div>
<!-- ====== Hero Section End -->